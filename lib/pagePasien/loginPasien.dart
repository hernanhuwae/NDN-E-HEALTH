...
import 'package:ndn_skin_cancer_app_capstone/pagePasien/monitoringPasien.dart';
...
class LoginPasien extends StatelessWidget {
  const LoginPasien({super.key});
              ...
              customTombolMasuk(
                ...
                navigasi: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => MonitoringPasien()));
                },
              )
            ],
          ),
